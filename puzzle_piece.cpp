...
namespace puzzle_game {
    ...
    void puzzle_piece::move(Vector2& pos){
        this->pos.x = pos.x;
        this->pos.y = pos.y;
    ...
    void puzzle_piece::swap(puzzle_piece* with){
    ...
    puzzle_piece::puzzle_piece(Vector2 pos, Texture2D img,Rectangle bounding_box) :
        pos{pos},
        img{img},
    ...
    bool puzzle_piece::operator==(const puzzle_piece& p){
